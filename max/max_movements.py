...
def set_pwm_percent(channel: int, percent: float) -> None:
    """Set PWM duty cycle on one channel."""
...
try:
    ...
    # print("All motors forward for 2 seconds")
    # forward(50)   
    # time.sleep(3)
    # stop()
    # time.sleep(1)

    # print("All motors backward for 2 seconds")
    # backward(50)
    # time.sleep(3)
    # stop()
    # time.sleep(1)
